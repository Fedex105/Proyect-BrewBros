...
class ProductoCompra extends React.Component{
    ...
    componentDidMount(){
        ...
        let resp = axios.get("http://uade.cdnapp.xyz/productos/" + queryDict.id);
        resp.then(x => {
            console.log(x.data)
    ...
    hayStock(){
        if(this.state.producto.stock > 0){
           return <p class="fs-4 py-3">Stock: {this.state.producto.stock}</p> 
        }else{
                            ...
                            <div class="col-md-6">
                                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item">
                                            <img height="500px" class="tamañoIMG" src={this.state.producto.imagenes === undefined?"":this.state.producto.imagenes[2]} alt=""></img>      
                                        </div>
                                    </div>
